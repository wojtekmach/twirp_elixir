  ...
  defp generate_service_modules(prefix, protos) do
    for proto <- protos do
      ...
      for service_name <- pb_mod.get_service_names() do
        messages =
          for rpc_name <- pb_mod.get_rpc_names(service_name) do
            """
            def #{Macro.underscore(Atom.to_string(rpc_name))}(url, params) do
              #{prefix}.RPC.Client.call(url, #{inspect(pb_mod)}, #{inspect(service_name)}, #{inspect(rpc_name)}, params)
            end
            """
          end

        write!(Path.join(service_root, "#{name}_client.ex"), """
        # Automatically generated by twirp_elixir, do not edit manually.
        ...
        write!(Path.join(service_root, "#{name}_server.ex"), """
        # Automatically generated by twirp_elixir, do not edit manually.
